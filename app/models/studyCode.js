 ...
 *   groupId          ObjectId|null  Ref to studies.groups[].id. Null for study-level codes (group assigned at redemption via weighted round-robin).
...
export const VALIDATOR = {
  $jsonSchema: {
    bsonType: 'object',
    required: ['code', 'studyId', 'redemptionCount', 'createdAt'],
    properties: {
