...
- Two now-removable `pubspec.yaml` dependencies once the dead files above are deleted:
  - `web_socket_channel` — used _exclusively_ by `recommendation_ws_service.dart`.
