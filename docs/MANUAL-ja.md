> **⚠️ レガシー文書。** 本マニュアルは、2026年6月に廃止されたブラウザベースの実験サイト（G1–G4ウェブページ、reCAPTCHA）について説明しています。現在の参加者はFlutterモバイルアプリをご利用ください（[guides/participant-guide.md](guides/participant-guide.md) 参照）。当初の研究デザインの歴史的参照のために保存されています。
