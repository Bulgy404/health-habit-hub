  ...
  db.surveys.insertMany([
    {
      ...
      pages: [
          ...
          elements: [
            ...
            },
            {
              ...
              choices: [
                ...
                {
                  value: 'Andorra',
                  text: { default: 'Andorra', de: 'Andorra', ja: 'アンドラ' },
                },
                {
                  value: 'Angola',
                  text: { default: 'Angola', de: 'Angola', ja: 'アンゴラ' },
                },
                {
                ...
                {
                  value: 'Bahamas',
                  text: { default: 'Bahamas', de: 'Bahamas', ja: 'バハマ' },
                },
                {
                  value: 'Bahrain',
                  text: { default: 'Bahrain', de: 'Bahrain', ja: 'バーレーン' },
                },
                {
                  value: 'Bangladesh',
                  text: {
                ...
                {
                  value: 'Belgium',
                  text: { default: 'Belgium', de: 'Belgien', ja: 'ベルギー' },
                },
                {
                  value: 'Belize',
                  text: { default: 'Belize', de: 'Belize', ja: 'ベリーズ' },
                },
                {
                  value: 'Benin',
                  text: { default: 'Benin', de: 'Benin', ja: 'ベナン' },
                },
                {
                  value: 'Bhutan',
                  text: { default: 'Bhutan', de: 'Bhutan', ja: 'ブータン' },
                },
                {
                  value: 'Bolivia',
                  text: { default: 'Bolivia', de: 'Bolivien', ja: 'ボリビア' },
                },
                {
                ...
                {
                  value: 'Botswana',
                  text: { default: 'Botswana', de: 'Botswana', ja: 'ボツワナ' },
                },
                {
                  value: 'Brazil',
                  text: { default: 'Brazil', de: 'Brasilien', ja: 'ブラジル' },
                },
                {
                  value: 'Brunei',
                  text: { default: 'Brunei', de: 'Brunei', ja: 'ブルネイ' },
                },
                {
                  value: 'Bulgaria',
                  text: {
                ...
                {
                  value: 'Burundi',
                  text: { default: 'Burundi', de: 'Burundi', ja: 'ブルンジ' },
                },
                {
                  value: 'Cambodia',
                  text: {
                ...
                {
                  value: 'Canada',
                  text: { default: 'Canada', de: 'Kanada', ja: 'カナダ' },
                },
                {
                  value: 'Cape Verde',
                  text: {
                ...
                {
                  value: 'Chad',
                  text: { default: 'Chad', de: 'Tschad', ja: 'チャド' },
                },
                {
                  value: 'Chile',
                  text: { default: 'Chile', de: 'Chile', ja: 'チリ' },
                },
                {
                  value: 'China',
                  text: { default: 'China', de: 'China', ja: '中国' },
                },
                {
                  value: 'Colombia',
                  text: {
                ...
                {
                  value: 'Comoros',
                  text: { default: 'Comoros', de: 'Komoren', ja: 'コモロ' },
                },
                {
                  value: 'Congo',
                  text: { default: 'Congo', de: 'Kongo', ja: 'コンゴ' },
                },
                {
                  value: 'Costa Rica',
                  text: {
                ...
                {
                  value: 'Cuba',
                  text: { default: 'Cuba', de: 'Kuba', ja: 'キューバ' },
                },
                {
                  value: 'Cyprus',
                  text: { default: 'Cyprus', de: 'Zypern', ja: 'キプロス' },
                },
                {
                ...
                {
                  value: 'Djibouti',
                  text: { default: 'Djibouti', de: 'Dschibuti', ja: 'ジブチ' },
                },
                {
                  value: 'Dominica',
                  text: { default: 'Dominica', de: 'Dominica', ja: 'ドミニカ' },
                },
                {
                ...
                {
                  value: 'Ecuador',
                  text: { default: 'Ecuador', de: 'Ecuador', ja: 'エクアドル' },
                },
                {
                  value: 'Egypt',
                  text: { default: 'Egypt', de: 'Ägypten', ja: 'エジプト' },
                },
                {
                  value: 'El Salvador',
                  text: {
                ...
                {
                  value: 'Eritrea',
                  text: { default: 'Eritrea', de: 'Eritrea', ja: 'エリトリア' },
                },
                {
                  value: 'Estonia',
                  text: { default: 'Estonia', de: 'Estland', ja: 'エストニア' },
                },
                {
                  value: 'Ethiopia',
                  text: {
                ...
                {
                  value: 'Fiji',
                  text: { default: 'Fiji', de: 'Fidschi', ja: 'フィジー' },
                },
                {
                  value: 'Finland',
                  text: {
                ...
                {
                  value: 'France',
                  text: { default: 'France', de: 'Frankreich', ja: 'フランス' },
                },
                {
                  value: 'Gabon',
                  text: { default: 'Gabon', de: 'Gabun', ja: 'ガボン' },
                },
                {
                  value: 'Gambia',
                  text: { default: 'Gambia', de: 'Gambia', ja: 'ガンビア' },
                },
                {
                  value: 'Georgia',
                  text: {
                ...
                {
                  value: 'Germany',
                  text: { default: 'Germany', de: 'Deutschland', ja: 'ドイツ' },
                },
                {
                  value: 'Ghana',
                  text: { default: 'Ghana', de: 'Ghana', ja: 'ガーナ' },
                },
                {
                  value: 'Greece',
                  text: {
                ...
                {
                  value: 'Grenada',
                  text: { default: 'Grenada', de: 'Grenada', ja: 'グレナダ' },
                },
                {
                  value: 'Guatemala',
                  text: {
                ...
                {
                  value: 'Guinea',
                  text: { default: 'Guinea', de: 'Guinea', ja: 'ギニア' },
                },
                {
                  value: 'Guinea-Bissau',
                  text: {
                ...
                {
                  value: 'Guyana',
                  text: { default: 'Guyana', de: 'Guyana', ja: 'ガイアナ' },
                },
                {
                  value: 'Haiti',
                  text: { default: 'Haiti', de: 'Haiti', ja: 'ハイチ' },
                },
                {
                  value: 'Honduras',
                  text: {
                ...
                {
                  value: 'Hong Kong',
                  text: { default: 'Hong Kong', de: 'Hongkong', ja: '香港' },
                },
                {
                  value: 'Hungary',
                  text: { default: 'Hungary', de: 'Ungarn', ja: 'ハンガリー' },
                },
                {
                  value: 'Iceland',
                  text: {
                ...
                {
                  value: 'India',
                  text: { default: 'India', de: 'Indien', ja: 'インド' },
                },
                {
                  value: 'Indonesia',
                  text: {
                ...
                {
                  value: 'Iran',
                  text: { default: 'Iran', de: 'Iran', ja: 'イラン' },
                },
                {
                  value: 'Iraq',
                  text: { default: 'Iraq', de: 'Irak', ja: 'イラク' },
                },
                {
                  value: 'Ireland',
                  text: {
                ...
                {
                  value: 'Israel',
                  text: { default: 'Israel', de: 'Israel', ja: 'イスラエル' },
                },
                {
                  value: 'Italy',
                  text: { default: 'Italy', de: 'Italien', ja: 'イタリア' },
                },
                {
                  value: 'Jamaica',
                  text: { default: 'Jamaica', de: 'Jamaika', ja: 'ジャマイカ' },
                },
                {
                  value: 'Japan',
                  text: { default: 'Japan', de: 'Japan', ja: '日本' },
                },
                {
                  value: 'Jordan',
                  text: { default: 'Jordan', de: 'Jordanien', ja: 'ヨルダン' },
                },
                {
                  value: 'Kazakhstan',
                  text: {
                ...
                {
                  value: 'Kenya',
                  text: { default: 'Kenya', de: 'Kenia', ja: 'ケニア' },
                },
                {
                  value: 'Kiribati',
                  text: { default: 'Kiribati', de: 'Kiribati', ja: 'キリバス' },
                },
                {
                  value: 'North Korea',
                  text: {
                ...
                {
                  value: 'South Korea',
                  text: { default: 'South Korea', de: 'Südkorea', ja: '韓国' },
                },
                {
                  value: 'Kuwait',
                  text: { default: 'Kuwait', de: 'Kuwait', ja: 'クウェート' },
                },
                {
                  value: 'Kyrgyzstan',
                  text: {
                ...
                {
                  value: 'Laos',
                  text: { default: 'Laos', de: 'Laos', ja: 'ラオス' },
                },
                {
                  value: 'Latvia',
                  text: { default: 'Latvia', de: 'Lettland', ja: 'ラトビア' },
                },
                {
                  value: 'Lebanon',
                  text: { default: 'Lebanon', de: 'Libanon', ja: 'レバノン' },
                },
                {
                  value: 'Lesotho',
                  text: { default: 'Lesotho', de: 'Lesotho', ja: 'レソト' },
                },
                {
                  value: 'Liberia',
                  text: { default: 'Liberia', de: 'Liberia', ja: 'リベリア' },
                },
                {
                  value: 'Libya',
                  text: { default: 'Libya', de: 'Libyen', ja: 'リビア' },
                },
                {
                  value: 'Liechtenstein',
                  text: {
                ...
                {
                  value: 'Macao',
                  text: { default: 'Macao', de: 'Macau', ja: 'マカオ' },
                },
                {
                  value: 'Madagascar',
                  text: {
                ...
                {
                  value: 'Malawi',
                  text: { default: 'Malawi', de: 'Malawi', ja: 'マラウイ' },
                },
                {
                  value: 'Malaysia',
                  text: {
                ...
                {
                  value: 'Mali',
                  text: { default: 'Mali', de: 'Mali', ja: 'マリ' },
                },
                {
                  value: 'Malta',
                  text: { default: 'Malta', de: 'Malta', ja: 'マルタ' },
                },
                {
                ...
                {
                  value: 'Mexico',
                  text: { default: 'Mexico', de: 'Mexiko', ja: 'メキシコ' },
                },
                {
                  value: 'Micronesia',
                  text: {
                ...
                {
                  value: 'Moldova',
                  text: { default: 'Moldova', de: 'Moldau', ja: 'モルドバ' },
                },
                {
                  value: 'Monaco',
                  text: { default: 'Monaco', de: 'Monaco', ja: 'モナコ' },
                },
                {
                  value: 'Mongolia',
                  text: { default: 'Mongolia', de: 'Mongolei', ja: 'モンゴル' },
                },
                {
                  value: 'Montenegro',
                  text: {
                ...
                {
                  value: 'Morocco',
                  text: { default: 'Morocco', de: 'Marokko', ja: 'モロッコ' },
                },
                {
                  value: 'Mozambique',
                  text: {
                ...
                {
                  value: 'Myanmar',
                  text: { default: 'Myanmar', de: 'Myanmar', ja: 'ミャンマー' },
                },
                {
                  value: 'Namibia',
                  text: { default: 'Namibia', de: 'Namibia', ja: 'ナミビア' },
                },
                {
                  value: 'Nauru',
                  text: { default: 'Nauru', de: 'Nauru', ja: 'ナウル' },
                },
                {
                  value: 'Nepal',
                  text: { default: 'Nepal', de: 'Nepal', ja: 'ネパール' },
                },
                {
                  value: 'Netherlands',
                  text: {
                ...
                {
                  value: 'Niger',
                  text: { default: 'Niger', de: 'Niger', ja: 'ニジェール' },
                },
                {
                  value: 'Nigeria',
                  text: {
                ...
                {
                  value: 'Norway',
                  text: { default: 'Norway', de: 'Norwegen', ja: 'ノルウェー' },
                },
                {
                  value: 'Oman',
                  text: { default: 'Oman', de: 'Oman', ja: 'オマーン' },
                },
                {
                  value: 'Pakistan',
                  text: {
                ...
                {
                  value: 'Palau',
                  text: { default: 'Palau', de: 'Palau', ja: 'パラオ' },
                },
                {
                  value: 'Panama',
                  text: { default: 'Panama', de: 'Panama', ja: 'パナマ' },
                },
                {
                ...
                {
                  value: 'Peru',
                  text: { default: 'Peru', de: 'Peru', ja: 'ペルー' },
                },
                {
                  value: 'Philippines',
                  text: {
                ...
                {
                  value: 'Poland',
                  text: { default: 'Poland', de: 'Polen', ja: 'ポーランド' },
                },
                {
                  value: 'Portugal',
                  text: {
                ...
                {
                  value: 'Qatar',
                  text: { default: 'Qatar', de: 'Katar', ja: 'カタール' },
                },
                {
                  value: 'Romania',
                  text: {
                ...
                {
                  value: 'Russia',
                  text: { default: 'Russia', de: 'Russland', ja: 'ロシア' },
                },
                {
                  value: 'Rwanda',
                  text: { default: 'Rwanda', de: 'Ruanda', ja: 'ルワンダ' },
                },
                {
                ...
                {
                  value: 'Samoa',
                  text: { default: 'Samoa', de: 'Samoa', ja: 'サモア' },
                },
                {
                  value: 'San Marino',
                  text: {
                ...
                {
                  value: 'Senegal',
                  text: { default: 'Senegal', de: 'Senegal', ja: 'セネガル' },
                },
                {
                  value: 'Serbia',
                  text: { default: 'Serbia', de: 'Serbien', ja: 'セルビア' },
                },
                {
                  value: 'Seychelles',
                  text: {
                ...
                {
                  value: 'Somalia',
                  text: { default: 'Somalia', de: 'Somalia', ja: 'ソマリア' },
                },
                {
                  value: 'South Africa',
                  text: {
                ...
                {
                  value: 'Spain',
                  text: { default: 'Spain', de: 'Spanien', ja: 'スペイン' },
                },
                {
                  value: 'Sri Lanka',
                  text: {
                ...
                {
                  value: 'Sudan',
                  text: { default: 'Sudan', de: 'Sudan', ja: 'スーダン' },
                },
                {
                  value: 'Suriname',
                  text: { default: 'Suriname', de: 'Surinam', ja: 'スリナム' },
                },
                {
                  value: 'Sweden',
                  text: {
                ...
                {
                  value: 'Switzerland',
                  text: { default: 'Switzerland', de: 'Schweiz', ja: 'スイス' },
                },
                {
                  value: 'Syria',
                  text: { default: 'Syria', de: 'Syrien', ja: 'シリア' },
                },
                {
                  value: 'Taiwan',
                  text: { default: 'Taiwan', de: 'Taiwan', ja: '台湾' },
                },
                {
                  value: 'Tajikistan',
                  text: {
                ...
                {
                  value: 'Thailand',
                  text: { default: 'Thailand', de: 'Thailand', ja: 'タイ' },
                },
                {
                  value: 'Timor-Leste',
                  text: {
                ...
                {
                  value: 'Togo',
                  text: { default: 'Togo', de: 'Togo', ja: 'トーゴ' },
                },
                {
                  value: 'Tonga',
                  text: { default: 'Tonga', de: 'Tonga', ja: 'トンガ' },
                },
                {
                ...
                {
                  value: 'Turkey',
                  text: { default: 'Turkey', de: 'Türkei', ja: 'トルコ' },
                },
                {
                  value: 'Turkmenistan',
                  text: {
                ...
                {
                  value: 'Tuvalu',
                  text: { default: 'Tuvalu', de: 'Tuvalu', ja: 'ツバル' },
                },
                {
                  value: 'Uganda',
                  text: { default: 'Uganda', de: 'Uganda', ja: 'ウガンダ' },
                },
                {
                  value: 'Ukraine',
                  text: { default: 'Ukraine', de: 'Ukraine', ja: 'ウクライナ' },
                },
                {
                ...
                {
                  value: 'Uruguay',
                  text: { default: 'Uruguay', de: 'Uruguay', ja: 'ウルグアイ' },
                },
                {
                  value: 'Uzbekistan',
                  text: {
                ...
                {
                  value: 'Vanuatu',
                  text: { default: 'Vanuatu', de: 'Vanuatu', ja: 'バヌアツ' },
                },
                {
                  value: 'Vatican City',
                  text: {
                ...
                {
                  value: 'Vietnam',
                  text: { default: 'Vietnam', de: 'Vietnam', ja: 'ベトナム' },
                },
                {
                  value: 'Yemen',
                  text: { default: 'Yemen', de: 'Jemen', ja: 'イエメン' },
                },
                {
                  value: 'Zambia',
                  text: { default: 'Zambia', de: 'Sambia', ja: 'ザンビア' },
                },
                {
                  value: 'Zimbabwe',
                  text: {
        ...
        },
        {
          ...
          description: {
            default:
              'For each of the following statements, please select a point on the scale to indicate the extent to which you agree or disagree.',
        ...
        },
        {
          ...
          description: {
            default:
              'Please rate your experience with the system on the following scales.',
...
console.log(
  'Survey data inserted successfully. Survey count:',
...
console.log(
  'Results data inserted successfully. Results count:',
