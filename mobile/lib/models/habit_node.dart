...
class HabitNode {
  ...
  ///
  /// Uses [displayText] (server-resolved translation) as [name]. If the
  /// response has no [displayText], falls back to [original].
  /// [requestedLang] is used to determine [hasTranslation].
