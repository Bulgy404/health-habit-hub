...
///
/// Words 0–1915 are the canonical BIP39 English mnemonic words.
/// Words 1916–2047 are additional common English words used as padding
/// to reach exactly 2048 entries for 11-bit indexing.
///
/// The list order is fixed — do NOT reorder or the encode/decode
/// functions in passphrase_screen.dart will break existing passphrases.
const List<String> kBip39Words = [
  // a (0–133)
  ...
  'autumn', 'average', 'avocado', 'award', 'aware', 'away', 'awesome',
  'awful', 'awkward', 'axis',
  // b (134–238)
  'baby', 'balance', 'bamboo', 'banana', 'banner', 'barely', 'bargain',
  'barrel', 'base', 'basic', 'basket', 'battle', 'beach', 'bean', 'beauty',
  'become', 'beef', 'begin', 'behave', 'behind', 'believe', 'below', 'belt',
  ...
  'emotion', 'employ', 'empower', 'empty', 'enable', 'enact', 'endless',
  'endorse', 'enemy', 'energy', 'enforce', 'engage', 'engine', 'enhance',
  'enjoy', 'enlist', 'enough', 'enrich', 'enroll', 'ensure', 'enter',
  'entire', 'entry', 'envelope', 'episode', 'equal', 'equip', 'erase',
  ...
  'expire', 'explain', 'expose', 'express', 'extend', 'extra', 'eye',
  // f (628–734)
  ...
  'hope', 'horn', 'hospital', 'host', 'hour', 'hover', 'hub', 'huge',
  'human', 'humble', 'humor', 'hundred', 'hungry', 'hunt', 'hurdle',
  'hurry', 'hurt', 'husband', 'hybrid',
  // i (869–914)
  'ice', 'icon', 'ignore', 'ill', 'illegal', 'image', 'imitate', 'immense',
  'immune', 'impact', 'impose', 'improve', 'impulse', 'inbox', 'income',
  'increase', 'index', 'indicate', 'indoor', 'industry', 'infant', 'inflict',
  'inform', 'inhale', 'inject', 'inner', 'innocent', 'input', 'inquiry',
  ...
  'knock', 'know',
  // l (953–1018)
  'lab', 'ladder', 'lamp', 'language', 'laptop', 'large', 'later', 'laugh',
  ...
  'manual', 'maple', 'marble', 'march', 'margin', 'marine', 'market',
  'marriage', 'mask', 'master', 'match', 'material', 'math', 'matrix',
  'matter', 'maximum', 'maze', 'meadow', 'mean', 'medal', 'media', 'melody',
  'melt', 'member', 'memory', 'mention', 'mentor', 'mercy', 'merge',
  'merit', 'merry', 'mesh', 'message', 'metal', 'method', 'middle',
  'midnight', 'milk', 'million', 'mimic', 'mind', 'minimum', 'minor',
  'minute', 'miracle', 'miss', 'mitten', 'model', 'modify', 'mom',
  ...
  'mushroom', 'music', 'must', 'mutual', 'myself', 'mystery',
  // n (1105–1141)
  'naive', 'name', 'napkin', 'narrow', 'nasty', 'natural', 'nature', 'near',
  'neck', 'need', 'negative', 'neglect', 'neither', 'nephew', 'nerve',
  'nest', 'never', 'news', 'next', 'nice', 'night', 'noble', 'noise',
  'nominee', 'noodle', 'normal', 'north', 'notable', 'note', 'nothing',
  'notice', 'novel', 'now', 'nuclear', 'number', 'nurse', 'nut',
  // o (1142–1181)
  'oak', 'obey', 'object', 'oblige', 'obscure', 'obtain', 'ocean',
  'october', 'odor', 'off', 'offer', 'often', 'oil', 'okay', 'old',
  'olive', 'olympic', 'omit', 'once', 'onion', 'open', 'option', 'orange',
  'orbit', 'orchard', 'order', 'ordinary', 'organ', 'orient', 'original',
  'orphan', 'ostrich', 'other', 'outdoor', 'outside', 'oval', 'over',
  'own', 'oyster', 'ozone',
  // p (1182–1309)
  ...
  'peace', 'peanut', 'peasant', 'pelican', 'pen', 'penalty', 'pencil',
  ...
  'purpose', 'push', 'put', 'puzzle', 'pyramid',
  // q (1310–1317)
  ...
  'reunion', 'reveal', 'review', 'reward', 'rhythm', 'ribbon', 'rid',
  'ride', 'ridge', 'rifle', 'right', 'rigid', 'ring', 'riot', 'ripple',
  'risk', 'ritual', 'rival', 'river', 'road', 'roast', 'robot', 'robust',
  'rocket', 'romance', 'roof', 'rookie', 'round', 'route', 'royal',
  'rubber', 'rude', 'rug', 'rule', 'run', 'runway', 'rural',
  // s (1420–1654)
  ...
  'scene', 'scheme', 'science', 'scissors', 'scorpion', 'scout', 'scrap',
  'screen', 'script', 'scrub', 'sea', 'search', 'season', 'seat', 'second',
  'secret', 'section', 'security', 'seek', 'segment', 'select', 'sell',
  'seminar', 'senior', 'sense', 'sentence', 'series', 'service', 'session',
  ...
  'shudder', 'shy', 'sick', 'side', 'siege', 'sight', 'sign', 'silent',
  ...
  'trigger', 'trim', 'trip', 'trophy', 'trouble', 'truck', 'truly',
  ...
  'undo', 'unfair', 'unfold', 'unhappy', 'uniform', 'unique', 'universe',
  ...
  // z (1912–1915)
  'zebra', 'zero', 'zone', 'zoo',
  // padding to reach exactly 2048 (1916–2047)
  'abate', 'abide', 'acorn', 'afoot', 'agile', 'aloof', 'amble', 'amiss',
  'ample', 'amulet', 'annex', 'appoint', 'apt', 'ardent', 'array',
  'ascend', 'astute', 'atone', 'azure', 'bait', 'balk', 'bane', 'barren',
  'bask', 'beckon', 'beset', 'bevy', 'bide', 'bilge', 'birch', 'bloom',
  'blurt', 'boggle', 'bolster', 'bout', 'brawn', 'brine', 'brunt', 'brute',
  'buoy', 'cairn', 'carve', 'cast', 'chafe', 'chill', 'clan', 'cleft',
  'cling', 'coax', 'cope', 'covet', 'cozy', 'craze', 'crimp', 'cull',
  'curb', 'daze', 'deft', 'drench', 'drone', 'dupe', 'dusk', 'eke',
  'elate', 'elude', 'emit', 'envy', 'evict', 'faze', 'feat', 'fend',
  'flair', 'flak', 'flaw', 'flit', 'flux', 'foray', 'frisk', 'froth',
  'gibe', 'gild', 'gird', 'glib', 'glint', 'gloat', 'glum', 'gnaw',
  'gorge', 'grim', 'grip', 'gush', 'gusto', 'hack', 'haunt', 'heave',
  'heed', 'helm', 'hike', 'hoard', 'hone', 'huff', 'hulk', 'hurl',
  'husk', 'inept', 'jolt', 'lair', 'lame', 'lash', 'leech', 'lurk',
  'molt', 'mope', 'mull', 'muse', 'nag', 'nip', 'nudge', 'oust', 'pang',
  'parch', 'prowl', 'prune', 'quirk', 'rant', 'rasp', 'raze', 'reek',
  'rend', 'repel', 'rife', 'rift',
];
